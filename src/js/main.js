...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================
    // 11. Tooltips (Simple Vanilla Implementation)
    // ==========================================
    const initTooltips = () => {
        ...
        triggers.forEach(trigger => {
            ...
            trigger.addEventListener('mouseenter', () => {
                ...
                tooltipEl.className = 'absolute z-[60] px-2 py-1 text-xs font-medium text-white bg-neutral-900 rounded shadow-sm dark:bg-neutral-800 pointer-events-none opacity-0 transition-opacity duration-200';
